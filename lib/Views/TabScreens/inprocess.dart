...
class InprocessTabs extends StatefulWidget {
  const InprocessTabs({super.key});

  @override
  _InprocessTabsState createState() => _InprocessTabsState();
}

class _InprocessTabsState extends State<InprocessTabs> {
