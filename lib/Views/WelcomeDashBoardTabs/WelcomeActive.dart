...
class WelcomeActiveTabs extends StatefulWidget {
  const WelcomeActiveTabs({super.key});

  @override
  _WelcomeActiveTabsState createState() => _WelcomeActiveTabsState();
}

class _WelcomeActiveTabsState extends State<WelcomeActiveTabs> {
