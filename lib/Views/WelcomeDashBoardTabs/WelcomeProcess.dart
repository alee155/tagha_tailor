...
class WelcomeInprocessTabs extends StatefulWidget {
  const WelcomeInprocessTabs({super.key});

  @override
  _WelcomeInprocessTabsState createState() => _WelcomeInprocessTabsState();
}

class _WelcomeInprocessTabsState extends State<WelcomeInprocessTabs> {
