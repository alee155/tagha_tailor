...
class WelcomeCompleteTabs extends StatefulWidget {
  const WelcomeCompleteTabs({super.key});

  @override
  _WelcomeCompleteTabsState createState() => _WelcomeCompleteTabsState();
}

class _WelcomeCompleteTabsState extends State<WelcomeCompleteTabs> {
